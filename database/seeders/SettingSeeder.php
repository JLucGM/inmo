    ...
    public function run()
    {
        $settingGeneral = [
            [
                ...
                'portadaBlog' => asset('img/setting/910.jpg'),
                'portadaFaq' => asset('img/setting/910.jpg'),
                'portadaContact' => asset('img/setting/910.jpg'),
                'portadaAnunciar' => asset('img/setting/910.jpg'),
                'titleBlog' => 'Blog',
                'titleFaq' => 'FAQ',
                ...
                'descriptionTestimonials' => 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec condimentum bibendum augue, maximus lacinia nisl tempus non.',
