...
return [
    ...
    'attributes' => [
        ...
        'bathrooms' => 'baños',
        'garages' => 'garajes',
        'totalMeters' => 'metros totales',
        'builtMeters' => 'metros construidos',
        'direction' => 'dirección',
        'types_properties_id' => 'tipo de propiedad',
        'phy_states_id' => 'estado físico',
        'types_businesses_id' => 'tipo de negocio',
        'country_id' => 'país',
        ...
        'content' => 'contenido',
        'extract' => 'extracto',
        'identificación_contact' => 'cédula de identidad',
        'start_time' => 'fecha de inicio',
        'end_time' => 'fecha de fin',
        'types_tasks_id' => 'tipo de tarea',
        'status_contacts_id' => 'estado',
        'body' => 'cuerpo',
        'token' => 'token',
        'contact_id' => 'contacto',
        'property_id' => 'propiedad',
