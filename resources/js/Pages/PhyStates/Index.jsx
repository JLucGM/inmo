...
export default function Index({ auth, phyStates, role, permission }) {
    return (
        <AuthenticatedLayout
            user={auth.user}
            roles={role}
            ...
            header={
                <div className='flex justify-between items-center px-6'>
                    <h2 className="capitalize font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Lista de Estados fisicos</h2>
        ...
        >
            <Head title="Lista de Estados fisicos" />
