...
export default function Index({ auth, setting }) {
    ...
    return (
        <AuthenticatedLayout
            ...
            header={
                <div className='flex justify-between items-center px-6'>
                    <h2 className="capitalize font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Setting</h2>
        ...
        >
            <Head className="capitalize" title="Setting" />
                                                    ...
                                                    <td className="border border-slate-200 px-6 py-4">
                                                        <div className='space-x-4'>
                                                            <Link
                                                                ...
                                                                href={route('setting.edit', [amenity])}>
                                                                Editar
                                                            </Link>
                                                            <Link
                                                                ...
                                                                href={route('setting.destroy', [amenity])} method='delete' as="button">
                                                                Eliminar
                                                            </Link>
                                                        </div>
                                                    </td>
