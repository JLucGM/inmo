        ...
        <AuthenticatedLayout
            ...
            header={
                <div className='flex justify-between items-center'>
                    <h2 className="capitalize font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Lista de Paginas</h2>
                                                    ...
                                                    <td className="border border-slate-200 px-6 py-4">
                                                        <div className='space-x-4'>
                                                            ...
                                                            <Link
                                                                ...
                                                                href={route('pages.destroy', [page])} method='delete' as="button">
                                                                Eliminar
                                                            </Link>
                                                        </div>
                                                    </td>
