...
export default function Index({ auth, categoryamenities }) {
    ...
    return (
        <AuthenticatedLayout
            ...
            header={
                <div className='flex justify-between items-center px-6'>
                    <h2 className="capitalize font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">categoria de comodidades</h2>
        ...
        >
            <Head className="capitalize" title="categoria de comodidades" />
                        ...
                        <div className=" text-gray-900 dark:text-gray-100">
                            ...
                            <div className="relative overflow-x-auto">
                                <table className="w-full border-collapse border text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 hover:border-collapse">
                                    ...
                                    <tbody>
                                        {
                                            categoryamenities?.map((categoryamenity) => (

                                                <tr key={categoryamenity.id} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                                    <th scope="row" className="border border-slate-200 px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                        {categoryamenity.name}
                                                    </th>                                                    
                                                    <td className="border border-slate-200 px-6 py-4">
                                                        <div className='space-x-4'>
                                                            <Link
                                                                className="py-2.5 px-5 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-full border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"
                                                                href={route('category-amenities.edit', [categoryamenity])}>
                                                                Editar
                                                            </Link>
                                                            <Link
                                                                ...
                                                                href={route('category-amenities.destroy', [categoryamenity])} method='delete' as="button">
                                                                Eliminar
                                                            </Link>
                                                        </div>
                                                    </td>
