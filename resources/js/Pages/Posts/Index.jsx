...
export default function Index({ auth, post }) {
    ...
    return (
        <AuthenticatedLayout
            ...
            header={
                <div className='flex justify-between items-center px-6'>
                    <h2 className="capitalize font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">posts</h2>
        ...
        >
            <Head className="capitalize" title="posts" />
                                                    ...
                                                    <td className="border border-slate-200 px-6 py-4">
                                                        <div className='space-x-4'>
                                                            ...
                                                            <Link
                                                                ...
                                                                href={route('post.destroy', [post])} method='delete' as="button">
                                                                Eliminar
                                                            </Link>
                                                        </div>
                                                    </td>
