...
export default function Create({ auth, statuses, contacts, typetasks, properties }) {
    ...
    const initialValues = {
        ...
        types_tasks_id: typetasks?.length > 0 ? typetasks[0].id.toString() : "",
        property_id: properties?.length > 0 ? properties[0].id.toString() : "",
        status_contacts_id: statuses?.length > 0 ? statuses[0].id.toString() : "",
    };
                            ...
                            <ContainerTitle title="Asignaciones y Estado">
                                <div className="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        {contacts?.length === 0 ? (
                                            <div className="text-sm text-gray-500 bg-gray-50 dark:bg-gray-800 p-2 rounded">No hay contactos disponibles</div>
                                        ) : (
                                            <Select value={data.contact_id} onValueChange={(val) => setData('contact_id', val)}>
                                                <SelectTrigger className="w-full"><SelectValue placeholder="Seleccionar contacto" /></SelectTrigger>
                                                <SelectContent>
                                    ...
                                    <div>
                                        ...
                                        {properties?.length === 0 ? (
                                            <div className="text-sm text-gray-500 bg-gray-50 dark:bg-gray-800 p-2 rounded">No hay propiedades disponibles</div>
                                        ) : (
                                            <Select value={data.property_id} onValueChange={(val) => setData('property_id', val)}>
                                                <SelectTrigger className="w-full"><SelectValue placeholder="Seleccionar propiedad" /></SelectTrigger>
                                                <SelectContent>
