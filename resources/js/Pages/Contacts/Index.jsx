                                    ...
                                    <tbody>
                                        {
                                            contacts?.map((contacts) => (
                                                ...
                                                <tr key={contacts.id} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                                    <th scope="row" className="border border-slate-200 px-6 py-4 capitalize font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                        {contacts.name}
                                                    </th>                                                    
                                                    <td className="border border-slate-200 px-6 py-4">
                                                        <div className='space-x-4'>
                                                            <Link
                                                                ...
                                                                href={route('contacts.edit', [contacts])}>
                                                                Editar
                                                            </Link>
                                                            <Link
                                                                ...
                                                                href={route('contacts.destroy', [contacts])} method='delete' as="button">
                                                                Eliminar
                                                            </Link>
                                                        </div>
                                                    </td>
